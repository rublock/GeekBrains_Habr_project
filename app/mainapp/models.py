...
class Status(models.Model):
    ...
    name = models.CharField(max_length=45, verbose_name='наименование статуса', unique=True)
...
class Comment(models.Model):
    # Модель комментариев
    user = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name='Автор', on_delete=models.CASCADE)
    parent_id = models.IntegerField(verbose_name='ID комментария', default=0, blank=True)
    post = models.ForeignKey(Post, verbose_name='Название статьи', on_delete=models.CASCADE)
...
class CommentLikes(models.Model):
    ...
    comment = models.ForeignKey(Comment, verbose_name='Название статьи', on_delete=models.CASCADE)
    like_count = models.CharField(verbose_name='Лайки', max_length=10, blank=False, choices=LIKE_CHOICES)
    user = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name='Автор', on_delete=models.CASCADE)
    active = models.BooleanField(verbose_name='активна', default=True, db_index=True)
